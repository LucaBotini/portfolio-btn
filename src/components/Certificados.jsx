...
const certificados = [
  {
    titulo: "Javascript",
    descricao:
      "Concluí o curso básico/intermediário de JavaScript pelo Curso em Vídeo, aprendendo lógica, manipulação do DOM e programação assíncrona.",
    horas: 40,
  ...
  },
  {
    titulo: "Java",
    descricao:
      "Concluí o curso de Java com a DevDojo, aprendendo desde os fundamentos da linguagem até conceitos avançados como POO, coleções e Streams.",
    horas: 80,
  ...
  },
  {
    titulo: "Linux",
    descricao:
      "Concluí o curso de Linux pelo Curso em Vídeo, aprendendo comandos, estrutura do sistema e administração básica.",
    horas: 40,
  ...
  },
  {
    titulo: "HTML5 & CSS3",
    descricao:
      "Concluí o curso de HTML5 & CSS3 pelo Curso em Vídeo, aprendendo a estruturar e estilizar páginas web com boas práticas e design responsivo.",
    horas: 40,
  ...
  },
  {
    ...
    descricao:
      "Curso de Node, Express e MongoDB pela Udemy com Matheus Battisti, onde aprendi a desenvolver APIs RESTful, lidar com rotas, middlewares e conexões com banco de dados SQL/NoSQL, aplicando boas práticas na construção de backends escaláveis e seguros.",
    horas: 40,
    link: "#",
  },
];
          ...
          <Carousel.Item key={index}>
            <Card className="bg-transparent text-white neon-border text-center">
              <Card.Body>
                ...
                <Button variant="primary" href={cert.link} target="_blank">
                  Ver Certificado
                </Button>
              </Card.Body>
            </Card>
